...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('session_session', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Session.modified'
        db.add_column('session_session', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2012, 10, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.created'
        db.delete_column('session_session', 'created')

        # Deleting field 'Session.modified'
        db.delete_column('session_session', 'modified')
    ...
    models = {
        ...
        'session.day': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 8, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'session.room': {
