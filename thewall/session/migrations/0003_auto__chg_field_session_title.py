...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('session_session', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Session.title'
        db.alter_column('session_session', 'title', self.gf('django.db.models.fields.CharField')(max_length=120))
