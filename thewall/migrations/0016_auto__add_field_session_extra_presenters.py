...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.extra_presenters'
        db.add_column(u'thewall_session', 'extra_presenters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.extra_presenters'
        db.delete_column(u'thewall_session', 'extra_presenters')
    ...
    models = {
        ...
        u'thewall.day': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
