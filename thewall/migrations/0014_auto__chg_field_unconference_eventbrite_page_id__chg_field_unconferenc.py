...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'thewall_unconference', 'eventbrite_page_id', self.gf('django.db.models.fields.CharField')(max_length=31, null=True))

        # Changing field 'Unconference.actionkit_page_id'
        db.alter_column(u'thewall_unconference', 'actionkit_page_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Unconference.eventbrite_page_id'
        db.alter_column(u'thewall_unconference', 'eventbrite_page_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=31))

        # Changing field 'Unconference.actionkit_page_id'
        db.alter_column(u'thewall_unconference', 'actionkit_page_id', self.gf('django.db.models.fields.IntegerField')(default=None))
