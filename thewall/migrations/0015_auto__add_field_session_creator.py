...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.creator'
        db.add_column(u'thewall_session', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth_email.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.creator'
        db.delete_column(u'thewall_session', 'creator_id')
    ...
    models = {
        ...
        u'thewall.day': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
