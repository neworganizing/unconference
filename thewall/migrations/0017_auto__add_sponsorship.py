...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'thewall_sponsorship', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['noi_websystem.Organization'])),
        ...
        db.send_create_signal(u'thewall', ['Sponsorship'])


    def backwards(self, orm):
        # Deleting model 'Sponsorship'
        db.delete_table(u'thewall_sponsorship')
    ...
    models = {
        ...
        u'thewall.day': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
