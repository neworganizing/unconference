...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unconference.name'
        db.alter_column(u'thewall_unconference', 'name', self.gf('django.db.models.fields.CharField')(max_length=127))

    def backwards(self, orm):

        # Changing field 'Unconference.name'
        db.alter_column(u'thewall_unconference', 'name', self.gf('django.db.models.fields.TextField')(max_length=127))
