...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field participants on 'Unconference'
        m2m_table_name = db.shorten_name(u'thewall_unconference_participants')
        ...
        db.create_unique(m2m_table_name, ['unconference_id', 'participant_id'])


    def backwards(self, orm):
        # Removing M2M table for field participants on 'Unconference'
        db.delete_table(db.shorten_name(u'thewall_unconference_participants'))
    ...
    models = {
        ...
        u'thewall.session': {
            'Meta': {'unique_together': "(('unconference', 'slot', 'room'),)", 'object_name': 'Session'},
        ...
        u'thewall.unconference': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['thewall.Participant']", 'symmetrical': 'False'}),
