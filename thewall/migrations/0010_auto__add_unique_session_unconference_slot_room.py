...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Session', fields ['unconference', 'slot', 'room']
        db.create_unique(u'thewall_session', ['unconference_id', 'slot_id', 'room_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Session', fields ['unconference', 'slot', 'room']
        db.delete_unique(u'thewall_session', ['unconference_id', 'slot_id', 'room_id'])
