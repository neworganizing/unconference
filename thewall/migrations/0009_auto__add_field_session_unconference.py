...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.unconference'
        db.add_column(u'thewall_session', 'unconference',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thewall.Unconference'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.unconference'
        db.delete_column(u'thewall_session', 'unconference_id')
