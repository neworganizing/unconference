...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vote'
        db.create_table(u'thewall_vote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['thewall.Session'])),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes', to=orm['thewall.Participant'])),
            ('value', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'thewall', ['Vote'])

        # Adding unique constraint on 'Vote', fields ['participant', 'session']
        db.create_unique(u'thewall_vote', ['participant_id', 'session_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['participant', 'session']
        db.delete_unique(u'thewall_vote', ['participant_id', 'session_id'])

        # Deleting model 'Vote'
        db.delete_table(u'thewall_vote')
    ...
    models = {
        ...
        u'thewall.day': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
