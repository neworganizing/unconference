...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unconference.eventbrite_page_id'
        db.add_column(u'thewall_unconference', 'eventbrite_page_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Unconference.actionkit_page_id'
        db.add_column(u'thewall_unconference', 'actionkit_page_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unconference.eventbrite_page_id'
        db.delete_column(u'thewall_unconference', 'eventbrite_page_id')

        # Deleting field 'Unconference.actionkit_page_id'
        db.delete_column(u'thewall_unconference', 'actionkit_page_id')
    ...
    models = {
        ...
        u'thewall.unconference': {
            ...
            'eventbrite_page_id': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
