...
urlpatterns = patterns('',
    ...
    url(r'^users/new/?$', views.CreateUserView.as_view(), name='create_user'),
    ...
    url(r'^(?P<unconf>[a-zA-Z0-9\-]+)/sessions/(?P<action>[a-zA-Z]+)/?$', views.SessionView.as_view(), name='session_action'),
    url(r'^(?P<unconf>[a-zA-Z0-9\-]+)/sessions/(?P<id>[0-9]+)/(?P<action>[a-zA-Z]+)/$', views.SessionView.as_view(), name='session_id_action'),
