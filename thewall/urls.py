...
urlpatterns = patterns('',
    ...
    url(r'^sessions/(?P<id>[0-9]+)/vote/?$', views.VoteView.as_view(), name='vote'),
    url(r'^sessions/(?P<id>[0-9]+)/(?P<action>[a-zA-Z]+)/?$', views.SessionView.as_view(), name='session'),
    url(r'^sessions/(?P<id>[0-9a-zA-Z]+)/?$', views.SessionView.as_view(), name='session'),
    url(r'^sessions/?$', views.SessionView.as_view(), name='session'),
