...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SponsorPlugin'
        db.create_table(u'cmsplugin_sponsors_sponsorplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('unconference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thewall.Unconference'])),
        ))
        db.send_create_signal(u'cmsplugin_sponsors', ['SponsorPlugin'])


    def backwards(self, orm):
        # Deleting model 'SponsorPlugin'
        db.delete_table(u'cmsplugin_sponsors_sponsorplugin')
    ...
    models = {
        ...
        u'cmsplugin_sponsors.sponsorplugin': {
            'Meta': {'object_name': 'SponsorPlugin', '_ormbases': ['cms.CMSPlugin']},
    ...
    complete_apps = ['cmsplugin_sponsors']